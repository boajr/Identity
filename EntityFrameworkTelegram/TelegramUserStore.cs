...
/// of <see cref="IdentityTelegramUser{TKey}"/> with a string as a primary key.
/// </summary>
public class TelegramUserStore : TelegramUserStore<IdentityTelegramUser<string>>
{
    /// <summary>
    /// Constructs a new instance of <see cref="TelegramUserStore"/>.
    /// </summary>
    /// <param name="context">The <see cref="DbContext"/>.</param>
    /// <param name="describer">The <see cref="IdentityErrorDescriber"/>.</param>
    public TelegramUserStore(DbContext context, IdentityErrorDescriber? describer = null) : base(context, describer) { }
}
...
public class TelegramUserStore<TUser> : TelegramUserStore<TUser, IdentityRole, DbContext, string>
    where TUser : IdentityTelegramUser<string>, new()
{
    /// <summary>
    /// Constructs a new instance of <see cref="TelegramUserStore{TUser}"/>.
    /// </summary>
    /// <param name="context">The <see cref="DbContext"/>.</param>
    /// <param name="describer">The <see cref="IdentityErrorDescriber"/>.</param>
    public TelegramUserStore(DbContext context, IdentityErrorDescriber? describer = null) : base(context, describer) { }
...
public class TelegramUserStore<TUser, TRole, TContext> : TelegramUserStore<TUser, TRole, TContext, string>
    where TUser : IdentityTelegramUser<string>
    where TRole : IdentityRole<string>
    where TContext : DbContext
{
    /// <summary>
    /// Constructs a new instance of <see cref="TelegramUserStore{TUser, TRole, TContext}"/>.
    /// </summary>
    /// <param name="context">The <see cref="DbContext"/>.</param>
    /// <param name="describer">The <see cref="IdentityErrorDescriber"/>.</param>
    public TelegramUserStore(TContext context, IdentityErrorDescriber? describer = null) : base(context, describer) { }
}
...
public class TelegramUserStore<TUser, TRole, TContext, TKey> : TelegramUserStore<TUser, TRole, TContext, TKey, IdentityUserClaim<TKey>, IdentityUserRole<TKey>, IdentityUserLogin<TKey>, IdentityUserToken<TKey>, IdentityRoleClaim<TKey>, IdentityTelegramToken>
...
{
    /// <summary>
    /// Constructs a new instance of <see cref="TelegramUserStore{TUser, TRole, TContext, TKey}"/>.
    /// </summary>
    /// <param name="context">The <see cref="DbContext"/>.</param>
    /// <param name="describer">The <see cref="IdentityErrorDescriber"/>.</param>
    public TelegramUserStore(TContext context, IdentityErrorDescriber? describer = null) : base(context, describer) { }
...
public class TelegramUserStore<TUser, TRole, TContext, [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.All)] TKey, TUserClaim, TUserRole, TUserLogin, TUserToken, TRoleClaim, TTelegramToken> :
